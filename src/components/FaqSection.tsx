...
export default function FaqSection() {
  ...
  return (
    <section id="faq" className="relative py-24 scroll-mt-36">
      <div className="page-shell">
        <p className="text-center text-base font-semibold uppercase tracking-widest text-primary mb-2">
          Häufige Fragen
        </p>
        <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-12">
          FAQ
        </h2>
        ...
        <div className="mt-8 text-center">
          ...
          >
            Alle Antworten im Campus-Wissen
